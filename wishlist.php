...
<section class="products">
   ...
   <h3 class="heading">Tus deseos </h3>
   ...
   <div class="wishlist-total">
      <p>gran total : <span>$<?= $grand_total; ?>/-</span></p>
      <a href="shop.php" class="option-btn">Continuar comprando</a>
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('¿Eliminar todo de la lista de deseos?');">Eliminar todo el elemento</a>
   </div>
